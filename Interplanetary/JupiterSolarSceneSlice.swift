...
class JupiterSolarSceneSlice: SceneSlice {
    ...
    override func load(graphics: Graphics, interplanetaryScene: InterplanetaryScene) {
        ...
        sun_instructions.append(PlanetInstanceLayerInstruction(scale: 0.125, sprite: assetWadPlanetSkins.uvw_map_sun))
        sun.load(graphics: graphics, instructions: sun_instructions)
        
        var mercury_instructions = [PlanetInstanceLayerInstruction]()
        mercury_instructions.append(PlanetInstanceLayerInstruction(scale: 0.03, sprite: assetWadPlanetSkins.uvw_map_mercury))
        mercury.load(graphics: graphics, instructions: mercury_instructions)
        
        var venus_instructions = [PlanetInstanceLayerInstruction]()
        venus_instructions.append(PlanetInstanceLayerInstruction(scale: 0.07, sprite: assetWadPlanetSkins.uvw_map_venus))
        venus.load(graphics: graphics, instructions: venus_instructions)
        
        var earth_instructions = [PlanetInstanceLayerInstruction]()
        earth_instructions.append(PlanetInstanceLayerInstruction(scale: 0.08, sprite: assetWadPlanetSkins.uvw_map_earth))
        earth.load(graphics: graphics, instructions: earth_instructions)
        
        var mars_instructions = [PlanetInstanceLayerInstruction]()
        mars_instructions.append(PlanetInstanceLayerInstruction(scale: 0.125, sprite: assetWadPlanetSkins.uvw_map_mars))
        mars.load(graphics: graphics, instructions: mars_instructions)
        
        var jupiter_instructions = [PlanetInstanceLayerInstruction]()
        jupiter_instructions.append(PlanetInstanceLayerInstruction(scale: 0.45, sprite: assetWadPlanetSkins.uvw_map_jupiter))
        jupiter.load(graphics: graphics, instructions: jupiter_instructions)
