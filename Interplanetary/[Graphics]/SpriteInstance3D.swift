...
class SpriteInstance3D {
    ...
    var blendMode = SpriteInstance2D.BlendMode.none
    ...
    func set(x1: Float, x2: Float, y1: Float, y2: Float) {
        //
        setX1(x1)
        setY1(y1)
        //
    ...
    func render(renderEncoder: MTLRenderCommandEncoder) {
        ...
        case .alpha:
            graphics.set(pipelineState: .spriteNodeIndexed3DAlphaBlending, renderEncoder: renderEncoder)
        case .additive:
            graphics.set(pipelineState: .spriteNodeIndexed3DAdditiveBlending, renderEncoder: renderEncoder)
        case .premultiplied:
            graphics.set(pipelineState: .spriteNodeIndexed3DPremultipliedBlending, renderEncoder: renderEncoder)
        }
