...
struct Math {
    ...
    static func interpolate2(inputMin: Float, inputMax: Float, input: Float, outputMin: Float, outputMax: Float) -> Float {
    ...
    static func interpolate3(inputMin: Float,
                             inputMid: Float,
                             inputMax: Float,
                             input: Float,
                             outputMin: Float,
    ...
    static func interpolate4(inputMin: Float,
                             inputMid1: Float,
                             inputMid2: Float,
                             inputMax: Float,
                             input: Float,
    ...
    static func interpolate5(inputMin: Float,
                             inputMid1: Float,
                             inputMid2: Float,
                             inputMid3: Float,
                             inputMax: Float,
    ...
    static func mixPercentQuadratic(percent: Float, linearFactor: Float) -> Float {
        var percent = percent
    ...
    //Percent = 1.00 ==> {1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000}
    static func mixPercentQuadraticOpposite(percent: Float, linearFactor: Float) -> Float {
    ...
    //Percent = 1.00 ==> {1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000}
    static func mixPercentCubic(percent: Float, linearFactor: Float) -> Float {
        var percent = percent
        if percent > 1.0 { percent = 1.0 }
        if percent < 0.0 { percent = 0.0 }
        let lhs = percent * linearFactor
    ...
    //Percent = 1.00 ==> {1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000}
    static func mixPercentCubicOpposite(percent: Float, linearFactor: Float) -> Float {
        var percentInverse = (1.0 - percent)
        if percentInverse > 1.0 { percentInverse = 1.0 }
        if percentInverse < 0.0 { percentInverse = 0.0 }
        let lhs = percentInverse * linearFactor
    ...
    //Percent = 1.00 ==> {1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000, 1.000}
    static func mixPercentSin(percent: Float, linearFactor: Float) -> Float {
        var percent = percent
        if percent > 1.0 { percent = 1.0 }
        if percent < 0.0 { percent = 0.0 }
    ...
    static let pi_4_5 = Float.pi / 4.5
    static let pi_5 = Float.pi / 5.0
    static let pi_5_5 = Float.pi / 5.5
    static let pi_6 = Float.pi / 6.0
    static let pi_7 = Float.pi / 7.0
    static let pi_7_5 = Float.pi / 7.5
    ...
    static func percentThroughRange(value: Float, minimum: Float, maximum: Float) -> Float {
    ...
    static func rangeContainsValue(start: Float, end: Float, value: Float) -> Bool {
    ...
    static func fallOffOvershootInverse(input: Float, falloffStart: Float, resultMax: Float, inputMax: Float) -> Float {
        var result = input
